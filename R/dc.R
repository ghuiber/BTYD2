...
#' applying to each particular time period to construct seperate CBTs, and from
#' them, CBSs. That is a much cleaner and less error-prone method; however, on
#' occassion the data will not be available in event log format and you may not
