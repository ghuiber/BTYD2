...
#' modelled - this is due to the fact that a new customer generally does 
#' not show up "on the comapany's radar" until after their first 
...
#' @references Jerath, Kinshuk, Peter S. Fader, and Bruce G.S. Hardie. \dQuote{Customer-Base Analysis on a 'Data Diet': Model Inference Using Repeated Cross-Sectional Summary (RCSS) Data.} June. 2011. Available at SSRN: \url{http://ssrn.com/abstract=1708562} or \url{http://dx.doi.org/10.2139/ssrn.1708562}
