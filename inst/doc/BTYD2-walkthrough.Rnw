...
\section{Gabi Huiber's Disclaimer (September 15, 2019)}

The BTYD2 package is my attempt to patch the 
...
The original BTYD walkthrough applies to BTYD2 too. Everywhere below this 
section "the BTYD package" can be read as "the BTYD2 package." 
...
libraries, etc. now point to their BTYD2 counterparts. 

These BTYD2 counterparts have been modified as follows: 
\begin{itemize}
...
pdf(file = 'figure/pnbdCalibrationFit.pdf')
...
pdf(file = 'figure/pnbdTransactionHeterogeneity.pdf')
...
pdf(file = 'figure/pnbdDropoutHeterogeneity.pdf')
...
pdf(file = 'figure/pnbdCondExpComp.pdf')
...
pdf(file = 'figure/pnbdTrackingInc.pdf')
...
pdf(file = 'figure/pnbdTrackingCum.pdf')
...
cal.cbs <- cdnowSummary$cbs;
pdf(file = 'figure/bgnbdCalibrationFit.pdf')
...
pdf(file = 'figure/bgnbdTransactionHeterogeneity.pdf')
...
pdf(file = 'figure/bgnbdDropoutHeterogeneity.pdf')
...
pdf(file = 'figure/bgnbdCondExpComp.pdf')
...
<<fig.path="figure/", label="bgnbdTrackingInc", tidy=FALSE, echo=TRUE, fig.keep='none'>>=
T.cal <- cal.cbs[,"T.cal"]
T.tot <- 78
n.periods.final <- 78
pdf(file = 'figure/bgnbdTrackingInc.pdf')
...
<<fig.path="figure/", label="bgnbdTrackingCum", tidy=FALSE, echo=TRUE, fig.keep='none'>>=

cum.tracking.data <- cumsum(w.track.data)
pdf(file = 'figure/bgnbdTrackingCum.pdf')
...
pdf(file = 'figure/bgbbCalibrationFit.pdf')
...
pdf(file = 'figure/bgbbTransactionHeterogeneity.pdf')
...
pdf(file = 'figure/bgbbDropoutHeterogeneity.pdf')
...
pdf(file = 'figure/bgbbCondExpComp.pdf')
...
pdf(file = 'figure/bgbbCondExpCompRec.pdf')
...
pdf(file = 'figure/bgbbTrackingInc.pdf')
...
pdf(file = 'figure/bgbbTrackingCum.pdf')
